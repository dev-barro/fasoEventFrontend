          ...
          >
            <div class="swiper-wrapper">
              ...
              <div class="swiper-slide">
                <div class="testimonial-item">
                  <img
                    src="{{asset('assets_public/img/testimonials/testimonials-2.jpg')}}"
                    class="testimonial-img"
                    alt=""
                  />
                  <h3>Sara Wilsson</h3>
        ...
        <div class="container">
          ...
          >
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <img
                src="{{asset('assets_public/img/portfolio/OIP (1).jpg')}}"
                class="img-fluid"
                alt=""
              />
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-web">
              ...
              <div class="portfolio-info">
                ...
                ></a>
                <a
                  href="{{asset('portfolio-details.html')}}"
                  class="details-link"
                  title="More Details"
                  ><i class="bx bx-link"></i
                ></a>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-card">
              ...
              <div class="portfolio-info">
                ...
                <a
                  href="assets_public/img/portfolio/OIP (4).jpg"
                  data-gallery="portfolioGallery"
                  class="portfolio-lightbox preview-link"
                  title="Card 2"
                  ><i class="bx bx-plus"></i
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-web">
              ...
              <div class="portfolio-info">
                ...
                <a
                  href="assets_public/img/portfolio/OIP (5).jpg"
                  data-gallery="portfolioGallery"
                  class="portfolio-lightbox preview-link"
                  title="Web 2"
                  ><i class="bx bx-plus"></i
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-app">
              <img
                src="assets_public/img/portfolio/OIP (6).jpg"
                class="img-fluid"
                alt=""
              />
              <div class="portfolio-info">
                ...
                <a
                  href="assets_public/img/portfolio/OIP (6).jpg"
                  data-gallery="portfolioGallery"
                  class="portfolio-lightbox preview-link"
                  title="App 3"
                  ><i class="bx bx-plus"></i
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-card">
              ...
              <div class="portfolio-info">
                ...
                <a
                  href="assets_public/img/portfolio/OIP (7).jpg"
                  data-gallery="portfolioGallery"
                  class="portfolio-lightbox preview-link"
                  title="Card 1"
                  ><i class="bx bx-plus"></i
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-card">
              ...
              <div class="portfolio-info">
                ...
                <a
                  href="assets_public/img/portfolio/R (3).jpg"
                  data-gallery="portfolioGallery"
                  class="portfolio-lightbox preview-link"
                  title="Card 3"
                  ><i class="bx bx-plus"></i
            ...
            <div class="col-lg-4 col-md-6 portfolio-item filter-web">
              <img
                src="assets_public/img/portfolio/R (4).jpg"
                class="img-fluid"
                alt=""
              />
              <div class="portfolio-info">
                <h4>évènement 9</h4>
                <a
                  href="assets_public/img/portfolio/R (4).jpg"
                  data-gallery="portfolioGallery"
                  class="portfolio-lightbox preview-link"
                  title="Web 3"
                  ><i class="bx bx-plus"></i
          ...
          <div class="row">
            ...
            >
              <div class="member">
                <div class="member-img">
                  <img
                    src="assets_public/img/team/team-2.jpg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="social">
            ...
            >
              <div class="member">
                <div class="member-img">
                  <img
                    src="assets_public/img/team/team-3.jpg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="social">
            ...
            >
              <div class="member">
                <div class="member-img">
                  <img
                    src="assets_public/img/team/team-4.jpg"
                    class="img-fluid"
                    alt=""
                  />
                  <div class="social">
